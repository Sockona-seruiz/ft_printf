...
/*                                                 #+#   #+    #+    #+#      */
/*   Created: 2019/12/19 10:23:34 by seruiz       #+#   ##    ##    #+#       */
/*   Updated: 2019/12/19 10:23:37 by seruiz      ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
/*   Updated: 2019/12/19 10:23:17 by seruiz      ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
		...
		va_list *arg_list, int i)
{
	...
	if (str[i] == '.')
	{
		btn = 1;
		i++;
		if (str[i] != '*' && (t_struct->prec = ft_atoi(&str[i])) >= 0)
	...
	if (btn == 1 && t_struct->prec == 0 &&
			(str[i] == 'd' || str[i] == 'u' || str[i] == 'x'
			|| str[i] == 'X' || str[i] == 'i' || str[i] == 'p'))
		t_struct->prec = -1;
	return (i);
}
